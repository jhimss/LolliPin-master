...
public class ViewDragHelper {
     ...
     *
     * @param v View to layout_amount_send for horizontal scrollability
     ...
     * will return false.
     *
     * @param x X position to layout_amount_send in the parent's coordinate system
     * @param y Y position to layout_amount_send in the parent's coordinate system
     ...
     *
     * @param view Child view of the parent to hit layout_amount_send
     * @param x X position to layout_amount_send in the parent's coordinate system
     * @param y Y position to layout_amount_send in the parent's coordinate system
